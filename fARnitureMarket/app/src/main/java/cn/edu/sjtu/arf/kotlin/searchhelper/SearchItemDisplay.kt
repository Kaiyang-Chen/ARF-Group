...
class SearchItemDisplay(var UID: String? = null,
                        var name: String? = null,
                        var price: String? = null,
                        imageUrl: String? = null) {
    var imageUrl: String? by SearchItemDisplayDelegate(imageUrl)
}

class SearchItemDisplayDelegate private constructor ():
